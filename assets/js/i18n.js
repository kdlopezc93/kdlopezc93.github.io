...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "about.title": "About",
      "about.intro": "I have over 9 years of experience in software development, working on projects that include banking systems, regulatory compliance (AML), process automation, RPA, continuous integration, and frontend and backend development. Specialized in technologies such as Java, Angular, NodeJS, NestJS, Spring Boot, Kubernetes, and BonitaSoft, among others.",
      "about.subtitle": "Web Developer.",
      "about.quote": "«The interesting question is not whether machines can think, but whether humans can stop thinking like machines.» - Alan Turing",
      ...
      "skills.title": "Skills",
      "skills.quote1": "\"Sometimes people think that if a machine can do a job, it must be following some rule or set of instructions, when in fact it may be doing something quite original.\"",
      "skills.quote2": "-- Alan Turing",
    ...
    es: {
      ...
      "about.intro": "Tengo más de 9 años de experiencia en desarrollo de software, trabajando en proyectos que incluyen sistemas bancarios, cumplimiento regulatorio (AML), automatización de procesos, RPA, integración continua y desarrollo frontend y backend. Especializado en tecnologías como Java, Angular, NodeJS, NestJS, Spring Boot, Kubernetes y BonitaSoft, entre otras.",
      "about.subtitle": "Desarrollador Web.",
      "about.quote": "«La pregunta interesante no es si las máquinas pueden pensar, sino si los humanos pueden dejar de pensar como máquinas.» - Alan Turing",
      ...
      "skills.quote1": "\"A veces la gente piensa que si una máquina puede hacer un trabajo, debe estar siguiendo alguna regla o conjunto de instrucciones, cuando en realidad puede estar haciendo algo bastante original.\"",
      "skills.quote2": "-- Alan Turing",
